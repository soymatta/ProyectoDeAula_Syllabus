...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var campoContenidoProgramatico = document.querySelector('.campoContenidoProgramatico');
  var contentsAndStrategies_data = JSON.parse(campoContenidoProgramatico.getAttribute('data-contents'));
  ...
  contentsAndStrategies_data.forEach(function (data) {
    createNewBlock(data.content_name, data.strategies);
});
  ...
  document
    ...
    .addEventListener("click", handleCreateBlock);
});
